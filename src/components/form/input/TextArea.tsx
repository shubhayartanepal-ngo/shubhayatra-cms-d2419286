...
const TextArea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  (
    ...
    let textareaClasses = `w-full placeholder:text-gray-400 rounded-lg border px-4 py-2.5 text-sm shadow-theme-xs focus:outline-none ${className}`;
    ...
    if (disabled) {
      ...
      textareaClasses += ` bg-transparent text-gray-500 border-gray-300 focus:border-error-300 focus:ring focus:ring-error-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:focus:border-error-800`;
    } else {
